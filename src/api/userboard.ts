...
// baseFetch<IUserBoard[]>(`${ENDPOINT}/?userId=${userId}`, 'GET');

// const getByBoard = async (boardId: number) =>
// baseFetch<IUserBoard[]>(`${ENDPOINT}?boardId=${boardId}`, 'GET');
...
// const deleteUserBoard = async (id: number) =>
// baseFetch<IUserBoard>(`${ENDPOINT}/${id}`, 'DELETE');
